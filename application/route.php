...
Route::group('admin',function(){
    ...
    Route::group('',function(){
        ...
        Route::post('picture/pics_up','admin/picture/pics_up');
         //seo设置
        Route::any('about/seo','admin/about/seo',['methed'=>'post|get']);
        //经销商展示首页
        Route::get('dealer/index','admin/dealer/index');
        //添加经销商资料
        Route::any('dealer/tianjia','admin/dealer/tianjia',['methed'=>'get|post']);
        //修改经销商资料
        Route::any('dealer/xiugai','admin/dealer/xiugai',['methed'=>'get|post']);
        //删除经销商资料
        Route::post('dealer/shanchu','admin/dealer/shanchu');
        //经销商图片上传
        Route::post('dealer/pics_up','admin/dealer/pics_up');
