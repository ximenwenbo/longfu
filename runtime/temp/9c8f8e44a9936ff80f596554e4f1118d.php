<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"E:\WWW\www.yuan.com\deshiguanwang\public/../application/admin\view\picture\index.html";i:1546498302;s:70:"E:\WWW\www.yuan.com\deshiguanwang\application\admin\view\pub\head.html";i:1542938968;s:78:"E:\WWW\www.yuan.com\deshiguanwang\application\admin\view\picture\js_index.html";i:1543556722;s:70:"E:\WWW\www.yuan.com\deshiguanwang\application\admin\view\pub\foot.html";i:1541560345;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="pd-20">
  ...
  <div class="cl pd-5 bg-1 bk-gray mt-20">
    ...
    <a href="javascript:;" onclick="member_add('','<?php echo url('tianjia'); ?>','','510')" class="btn btn-primary radius"><i class="icon-plus"></i> 添加图片</a></span>
        ...
        $.ajax({
            ...
            success:function(msg){
                if(msg.info==1){
                    //更新图片
                    if(is_use==0){
                        var ig = '<img src="<?php echo config('admin_temp'); ?>no.gif" alt="" title="已下线" />';
                    }else{
                        var ig = '<img src="<?php echo config('admin_temp'); ?>yes.gif" alt="" title="已上线" />';
                    }
                    $(obj).html(ig);
