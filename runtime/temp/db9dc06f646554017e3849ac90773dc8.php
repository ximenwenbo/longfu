<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"E:\WWW\www.yuan.com\deshiguanwang\public/../application/home\view\index\index.html";i:1551238295;s:69:"E:\WWW\www.yuan.com\deshiguanwang\application\home\view\pub\head.html";i:1551261584;s:69:"E:\WWW\www.yuan.com\deshiguanwang\application\home\view\pub\foot.html";i:1550113599;}*/ ?>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="#"  id='hhh' class="navbar-brand">
                        <img src="<?php echo config('home_images'); ?>777.png" alt="logo" class="img-responsive logo">
                </a>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="title">
                    <div>
                        <h2>经销商- <span>风采展示</span></h2>
                        <p>Small Craftsman Service Display</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 paddnone"s>
                <div class="case-item">
                    <div class="case-img">
                        <img src="<?php echo substr($v['img'],1); ?>">
                    </div>
                    <div class="case-hover">
                        <div class="case-text">
                            <h2><?php echo $v['name']; ?></h2>
                            <h4><?php echo $v['address']; ?></h4>
