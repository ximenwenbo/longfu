<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"E:\WWW\www.yuan.com\deshiguanwang\public/../application/admin\view\profiles\index.html";i:1546931077;s:70:"E:\WWW\www.yuan.com\deshiguanwang\application\admin\view\pub\head.html";i:1542938968;s:79:"E:\WWW\www.yuan.com\deshiguanwang\application\admin\view\profiles\js_index.html";i:1542007368;s:70:"E:\WWW\www.yuan.com\deshiguanwang\application\admin\view\pub\foot.html";i:1541560345;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">	<a  id="tianjia" href="javascript:;" onclick="member_add('添加简介','<?php echo url('tianjia'); ?>','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加简介</a>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "没有任何记录" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>


				<td id="shu"><?php echo $v['id']; ?></td>
				<td ><?php echo $v['about_us']; ?></td>
