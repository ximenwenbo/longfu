<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"E:\WWW\www.yuan.com\deshiguanwang\public/../application/admin\view\dealer\tianjia.html";i:1551235691;s:70:"E:\WWW\www.yuan.com\deshiguanwang\application\admin\view\pub\head.html";i:1542938968;s:79:"E:\WWW\www.yuan.com\deshiguanwang\application\admin\view\dealer\js_tianjia.html";i:1551239624;s:70:"E:\WWW\www.yuan.com\deshiguanwang\application\admin\view\pub\foot.html";i:1541560345;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="edit">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea   cols="80"   rows="6"  name="content" style="OVERFLOW:   hidden"></textarea>
			</div>
		</div>
    ...
    $(function(){
        $('#edit').submit(function(evt){
            ...
            $.ajax({
                ...
                url:'<?php echo url("tianjia","",false); ?>',
                dataType:'json',
                data:shuju,
                type:'post',
