<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"E:\WWW\www.yuan.com\deshiguanwang\public/../application/admin\view\about\seo.html";i:1548315022;s:70:"E:\WWW\www.yuan.com\deshiguanwang\application\admin\view\pub\head.html";i:1542938968;s:70:"E:\WWW\www.yuan.com\deshiguanwang\application\admin\view\pub\foot.html";i:1541560345;s:74:"E:\WWW\www.yuan.com\deshiguanwang\application\admin\view\about\js_seo.html";i:1548315282;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form-admin-add" method="post"  action="">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo isset($info['title'])?$info['title']: ''; ?>" placeholder=""  name="title">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>关键词：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo isset($info['keywords'])?$info['keywords']: ''; ?>" placeholder=""  name="keywords">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
               ...
               <textarea id="detail_one" name="content"
                         style="width:540px;height:180px;"><?php echo isset($info['content'])?$info['content']: ''; ?></textarea>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(function(){
        $('#form-admin-add').submit(function(evt){
            ...
            //ajax传递数据到服务器端存储
            $.ajax({
                url:"<?php echo url('seo'); ?>",    // /admin/about/seo
                data:shuju,
                dataType:'json',
                type:'post',
                success:function(msg){
                    if(msg.info==1){
                        layer.alert('操作成功',{icon:6},function(){
                            ...
                            window.location.href='/admin/about/seo';
                            //② 关闭修改地址的弹框表单页面
                            layer_close();
                        });
                    }else{
